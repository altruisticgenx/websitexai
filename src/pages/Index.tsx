...
const Stack: React.FC<{
  ...
  className?: string;
  children: React.ReactNode;
}> = ({ gap = "md", className, children }) => (
  <div
    className={cn(gap === "sm" && "space-y-4", gap === "md" && "space-y-6", gap === "lg" && "space-y-10", className)}
  >
    {children}
  </div>
);
...
const RecentBuilds: React.FC = React.memo(() => {
  ...
  return (
    <PageSection id="builds" borderTop>
      <Stack>
        <motion.div
...
const PilotOffer: React.FC = React.memo(() => {
  return (
    <PageSection id="pilot" borderTop aria-labelledby="pilot-heading">
      <Stack gap="lg">
        <motion.div
          initial={{ opacity: 0, y: 14 }}
          whileInView={{ opacity: 1, y: 0 }}
...
const TypicalProgression: React.FC = React.memo(() => {
  return (
    <PageSection id="progression" borderTop>
      <Stack>
        <motion.div
          initial={{ opacity: 0, y: 14 }}
          whileInView={{ opacity: 1, y: 0 }}
...
const WhoBenefits: React.FC = React.memo(() => {
  ...
  return (
    <PageSection id="benefits" borderTop>
      <Stack>
        <motion.div
          initial={{ opacity: 0, y: 14 }}
          whileInView={{ opacity: 1, y: 0 }}
...
const AboutMe: React.FC = React.memo(() => {
  return (
    <PageSection id="about" borderTop>
      <Stack gap="lg">
        <motion.div
          initial={{ opacity: 0, y: 14 }}
          whileInView={{ opacity: 1, y: 0 }}
