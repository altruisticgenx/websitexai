...
const FeatureCardWithTooltip: React.FC<{
  ...
  return <Tooltip>
      <TooltipTrigger asChild>
        ...
        scale: 1.01,
        y: -1
      }} className={cn("group relative w-full overflow-hidden rounded-md border bg-gradient-to-br to-slate-950/80 p-4 backdrop-blur-sm transition-all", "touch-manipulation active:scale-[0.98] focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/50", colorClasses)} aria-label={`${item.title} – ${item.desc}`}>
